...
apply_hyprlock() {
  ...
  echo "source = $XDG_CONFIG_HOME/hypr/hyprlock.generated.conf" >"$XDG_CONFIG_HOME/hypr/hyprlock.conf"
  echo "source = $XDG_CONFIG_HOME/hypr/hyprlock.custom.conf" >>"$XDG_CONFIG_HOME/hypr/hyprlock.conf"
}
